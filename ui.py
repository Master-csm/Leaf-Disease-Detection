...
def corn():
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for Cecosopra Leaf Spot are:\n\n "
...
def rose():
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for Rust on Rose are: "
    remedies = tk.Label(text=rem, background="lightgreen",
                      fg="Brown", font=("", 15))
    remedies.grid(column=0, row=7, padx=10, pady=10)
...
def mango():
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for Mango Gall Midge are: "
    remedies = tk.Label(text=rem, background="lightgreen",
                      fg="Brown", font=("", 15))
    remedies.grid(column=0, row=7, padx=10, pady=10)
...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        if str_label == 'corn':
            diseasename = "Cercospora on Corn "
            ...
            button3 = tk.Button(text="Remedies", command=corn)
            ...
            r = tk.Label(text='Click below for remedies...', background="lightgreen", fg="Brown", font=("", 15))
            r.grid(column=0, row=5, padx=10, pady=10)
            button3 = tk.Button(text="Remedies", command=rose)
            button3.grid(column=0, row=6, padx=10, pady=10)
        elif str_label == 'mango':
            diseasename = "Mango Gall Midge"
            disease = tk.Label(text='Disease Name: ' + diseasename, background="lightgreen",
                               fg="Black", font=("", 15))
            disease.grid(column=0, row=4, padx=10, pady=10)
            r = tk.Label(text='Click below for remedies...', background="lightgreen", fg="Brown", font=("", 15))
            r.grid(column=0, row=5, padx=10, pady=10)
            button3 = tk.Button(text="Remedies", command=mango)
            button3.grid(column=0, row=6, padx=10, pady=10)
        else:
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir=r'C:\Users\DELL\Desktop\Testpictures12', title='Select image for analysis ',
